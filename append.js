...
const code = `\n\nexport const getSuppliers = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendSuccess(res, suppliers, "L?y danh sách nhà cung c?p thành công");
  } catch (error) {
...
export const addSupplier = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendSuccess(res, { id: result.insertId, ...req.body }, "Thêm nhà cung c?p thành công", 201);
  } catch (error) {
...
export const updateSupplier = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendSuccess(res, { id, ...req.body }, "C?p nh?t nhà cung c?p thành công");
  } catch (error) {
...
export const deleteSupplier = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    sendSuccess(res, { id }, "Xóa nhà cung c?p thành công");
  } catch (error) {
