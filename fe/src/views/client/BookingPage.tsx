                    ...
                    <div className="flex flex-wrap gap-2 mb-2 border-b border-gray-100 pb-4">
                      {uniqueAreas.map((area) => (
                        <button
                          ...
                          className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${selectedArea === area
                            ...
                            .map((table: any) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`cursor-pointer p-4 rounded-xl border-2 transition-all text-center flex flex-col justify-center items-center gap-1 w-[120px] ${isSelected
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-gray-100 pt-4">
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50/50 hover:bg-blue-50 text-blue-700 px-4 py-2.5 text-xs font-bold transition-all"
                    >
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-thin">
                {["Tất cả", ...menuCategoriesList.map((c) => c.name)].map((cat) => (
                  <button
                    ...
                    className={`shrink-0 px-3.5 py-1.5 rounded-full text-xs font-bold transition-all ${menuCategory === cat
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {filteredMenuItems.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className={`relative bg-white rounded-2xl border-2 transition-all overflow-hidden ${qty > 0 ? "border-orange-400 shadow-md" : "border-gray-100 hover:border-gray-200 hover:shadow-sm"
                          }`}
                      >
                        {/* Badge số lượng */}
                        {qty > 0 && (
