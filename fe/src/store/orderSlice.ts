...
const INITIAL_ORDERS: Order[] = [
  ...
  },
  {
    ...
    guestCount: 4,
    items: [
      { menuItemId: "m2", name: "Khoai tây chiên bơ tỏi", price: 45000, quantity: 2 },
      { menuItemId: "m9", name: "Trà đào cam sả", price: 45000, quantity: 2 },
    ],
  ...
  },
  {
    ...
    guestCount: 3,
    items: [
      { menuItemId: "m7", name: "Lẩu nấm thực dưỡng", price: 350000, quantity: 1 },
      { menuItemId: "m11", name: "Sinh tố bơ", price: 55000, quantity: 2 },
    ],
    status: ORDER_STATUS.PAID,
    totalAmount: 460000,
